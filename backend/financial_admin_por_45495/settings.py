"""
Django settings for financial_admin_por_45495 project.
...
ROOT_URLCONF = 'financial_admin_por_45495.urls'
...
WSGI_APPLICATION = 'financial_admin_por_45495.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "financial_admin_por_45495 API",
    "DESCRIPTION": "API documentation for financial_admin_por_45495 App",
    "VERSION": "v1",
}
